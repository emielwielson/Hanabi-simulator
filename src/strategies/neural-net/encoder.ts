...
/** Fixed size of the observation vector. Must match model input shape. 2-player: 50 + 8 = 58 (visibleCards + last action only). */
export const ENCODER_OUTPUT_SIZE = 58;

const MAX_HAND_SIZE = 5;
const ACTION_HISTORY_LAST_K = 1;
 ...
 * Layout: visibleCards partner hand (5*10=50) | last action only (1*8=8).
 * 2-player only: visibleCards is the partner's hand.
 */
